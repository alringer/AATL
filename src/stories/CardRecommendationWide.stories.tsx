...
const recommendationDefault: IRecommendation = {
    ...
    venue: mockVenue,
    title:
        'An amazingly rich and diverse range of edible delights. An amazingly rich and diverse range of edible delights',
    content:
...
storiesOf('Card: Wide Recommendation Card', module)
    ...
    .add('Profile - Full Card', () => {
        return <div style={{ maxWidth: '690px', width: '100%' }}><CardRecommendationWide type={CardRecommendationWideEnum.Profile} isFull={false} recommendation={RecommendationCardData.default} /></div>
    })
    .add('Profile - Long Title Full Card', () => {
        return <div style={{ maxWidth: '690px', width: '100%' }}><CardRecommendationWide type={CardRecommendationWideEnum.Profile} isFull={false} recommendation={RecommendationCardData.longTitle} /></div>
    })
    .add('Profile - Long Description Full Card', () => {
        return <div style={{ maxWidth: '690px', width: '100%' }}><CardRecommendationWide type={CardRecommendationWideEnum.Profile} isFull={false} recommendation={RecommendationCardData.longDescription} /></div>
    })
    .add('Profile - Long Title and Description Full Card', () => {
        return <div style={{ maxWidth: '690px', width: '100%' }}><CardRecommendationWide type={CardRecommendationWideEnum.Profile} isFull={false} recommendation={RecommendationCardData.longTitleAndDescription} /></div>
    })
    .add('Venue Page - Full Card', () => {
        return <CardRecommendationWide isFull={true} recommendation={RecommendationCardData.default} type={CardRecommendationWideEnum.Restaurant} />
    })
    .add('Venue Page - Long Title Full Card', () => {
        return <CardRecommendationWide isFull={true} recommendation={RecommendationCardData.longTitle} type={CardRecommendationWideEnum.Restaurant} />
    })
    .add('Venue Page - Long Description Full Card', () => {
        return <CardRecommendationWide isFull={true} recommendation={RecommendationCardData.longDescription} type={CardRecommendationWideEnum.Restaurant} />
    })
    .add('Venue Page - Long Title and Description Full Card', () => {
        return <CardRecommendationWide isFull={true} recommendation={RecommendationCardData.longTitleAndDescription} type={CardRecommendationWideEnum.Restaurant} />
    })
